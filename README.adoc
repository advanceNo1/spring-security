[![CI Build](https://github.com/spring-projects/spring-security/workflows/CI/badge.svg?branch=master)](https://github.com/spring-projects/spring-security/actions)
